...
interface CampaignBriefStepPanelProps {
  state: StepState
  followUp: string
...
export function CampaignBriefStepPanel({
  state,
  followUp,
  onFollowUpChange,
  onGenerate,
    ...
    <div className="mx-auto max-w-[720px] px-8 py-8">
      <div className="mb-6">
        <div className="mb-1 flex items-center gap-2 text-[13px] text-zinc-400">
          <span>Step 1 of {WORKFLOW_TOTAL_STEPS}</span>
          <span>·</span>
          <span>Gigity</span>
        </div>
      ...
      {isEmptyStart && (
        <div className="flex flex-col items-center justify-center gap-4 py-16">
          <p className="text-[13px] text-zinc-500">
            Ready to generate your campaign brief.
          </p>
          <button
            onClick={onGenerate}
        ...
        <div className="flex flex-col gap-5">
          {isLocked && (
            <div className="flex flex-wrap items-center justify-between gap-3">
              <p className="text-[13px] text-green-600">
                Approved - Re-open to edit the brief.
              </p>
              {state.llmResponse ? (
          ...
          <div className="flex gap-2">
            <textarea
              ...
              placeholder="Refine the brief… e.g. stronger hook, clearer CTA, different tone"
              rows={2}
